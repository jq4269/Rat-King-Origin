...
public enum Talent {
	...
	//Channeler T3
	BIGGER_BOW(imageAt(18, 11), 3, Aspect.MULTIFORM), DRIFTING_SPIRIT(imageAt(19,11), 3, Aspect.UTILITY), PATIENT_BOW(imageAt(20,11), 3, Aspect.DEFENSE), CHANNELING_SIGHT(imageAt(21, 11), 3, Aspect.UTILITY), SENTRY_SPIRIT(imageAt(22, 11), 3, Aspect.OFFENSE),
	//Spectral Blades T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, int tier){
		...
		switch (cls){
			...
			case CHANNELER:
				...
				Collections.addAll(tierTalents, BIGGER_BOW, DRIFTING_SPIRIT, PATIENT_BOW, CHANNELING_SIGHT, SENTRY_SPIRIT);
				break;
			case CHAMPION:
