...
public enum Talent {
	...
	//Channeler T3
	BIGGER_BOW(imageAt(15,11), 3, Aspect.MULTIFORM), DRIFTING_SPIRIT(121, 3, Aspect.UTILITY), PATIENT_BOW(120, 3, Aspect.DEFENSE), CHANNELING_SIGHT(119, 3, Aspect.UTILITY), SENTRY_SPIRIT(115, 3, Aspect.OFFENSE),
	//Spectral Blades T4
