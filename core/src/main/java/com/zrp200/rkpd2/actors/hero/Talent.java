...
public enum Talent {
	...
	//Cenobite T3
    ARS_RETRACTANDI(imageAt(8, 13), 3), MESSIS_POTENTIAE(imageAt(9, 13), 3, Aspect.MULTIFORM), PETITIO_MAGICA(imageAt(10, 13), 3),
    //Ascended Form T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, int tier){
		...
		switch (cls){
			...
			case PALADIN:
				...
				break;
            case CENOBITE:
                Collections.addAll(tierTalents, ARS_RETRACTANDI, MESSIS_POTENTIAE, PETITIO_MAGICA);
                break;
