...
public class Assets {
	...
	public static class Environment {
		...
		public static final String PRISON_EXIT      = "environment/custom_tiles/prison_exit_new.png";
	...
	public static class Sounds {
		...
		public static final String BIRD = "sounds/bird.mp3";
		...
		public static final String R       = "sounds/r.mp3";
		...
		public static final String[] all = new String[]{
				...
				HIT_ARROW, ATK_SPIRITBOW, ATK_CROSSBOW, HEALTH_WARN, HEALTH_CRITICAL, BIRD,

				DESCEND, EAT, READ, LULLABY, DRINK, SHATTER, ZAP, LIGHTNING, LEVELUP, DEATH,
				CHALLENGE, CURSED, TRAP, EVOKE, TOMB, ALERT, MELD, BOSS, BLAST, PLANT, RAY, BEACON,
				TELEPORT, CHARMS, MASTERY, PUFF, ROCKS, BURNING, FALLING, GHOST, SECRET, BONES,
				BEE, DEGRADE, MIMIC, DEBUFF, CHARGEUP, GAS, CHAINS, SCAN, SHEEP, MINE, LEVELDOWN, R
		};
	}
	...
	public static class Sprites {
		...
		public static final String THREADRIPPER	= "sprites/threadripper.png";
		...
		public static final String ROYAL_OWL= "sprites/royal_owl.png";
